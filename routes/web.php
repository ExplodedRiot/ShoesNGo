...
Route::get('profile/{id}',[App\Http\Controllers\ProfileController::class, 'index'])->name('home');
Route::get('profile/{id}',[App\Http\Controllers\ProfileController::class, 'update'])->name('update');
