...
Route::get('check-out/{id}', [App\Http\Controllers\MessageController::class, 'check-out'])->name('message');
...
Route::get('profile',[App\Http\Controllers\ProfileController::class, 'update'])->name('update');
